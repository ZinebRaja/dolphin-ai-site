...
const CAPABILITIES = [
  {
    ...
    definition: 'Spend classification is the process of automatically categorizing every purchase transaction into a structured hierarchy — such as IT Hardware → Computers → Laptops. Without it, your procurement data is just a list of numbers.',
